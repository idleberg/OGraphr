					...
					<dl id="advanced_opt">
						...
						<tbody>
							...
							<tr valign="top"> 
								...
								<td><small>Once an user-agent has been selected, the plugin will only be triggered when called by any of these sites. Google+ currently uses no unique <a href="http://code.google.com/p/google-plus-platform/issues/detail?id=178" target="_blank" >user-agent</a>!</small></td> 
								<td>&nbsp;</td>
							</tr>
