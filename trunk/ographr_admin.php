		...
		<form method="post" action="options.php">
			...
			<table id="outer"><tbody><tr><td class="left">
					...
					<dl>
						...
						<td width="30px"><input type="text" size="60" name="ographr_options[website_title]" value="<?php if ($options['website_title']) { echo $options['website_title']; } else { echo '%postname%';} ?>" /></td> 
						<td></td>
						</tr>
						...
						<tr valign="center"> 
							...
							<td><input type="text" size="60" name="ographr_options[website_thumbnail]" value="<?php echo $options['website_thumbnail']; ?>" /></td> 
					...
					<dl>
						...
						<dd>
							...
							<td width="30px"><input type="text" size="60" name="ographr_options[website_description]" value="<?php echo $options['website_description']; ?>" /></td> 
							<td><small>(optional)</small></td>
							</tr>
					...
					<dl id="advanced_opt">
						...
						<tbody>
							...
							<tr valign="top"> 
								...
								<td><textarea name="ographr_options[filter_custom_urls]" cols="69%" rows="4" ><?php echo $options['filter_custom_urls']; ?></textarea><br/>
							...
							<tr valign="top"> 
								...
								<td><small>Once user-agent was selected, this plugin will only trigger when called by any of these sites. Google+ currently uses no unique <a href="http://code.google.com/p/google-plus-platform/issues/detail?id=178" target="_blank" >user-agent</a>!</small></td> 
								<td>&nbsp;</td>
							</tr>
					...
					<dl id="advanced_opt">
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[bandcamp_api]" value="<?php echo $options['bandcamp_api']; ?>" /></td> 
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[official_api]" value="<?php if ($options['official_api']) { echo $options['official_api']; } else { echo OFFICIAL_API_KEY; } ?>" /></td> 
						<td><small>(optional)</small></td>
						</tr>
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[soundcloud_api]" value="<?php if ($options['soundcloud_api']) { echo $options['soundcloud_api']; } else { echo SOUNDCLOUD_API_KEY; } ?>" /></td> 
						<td><small>(optional)</small></td>
						</tr>
					...
					<dl id="advanced_opt">
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[fb_site_name]" value="<?php echo $options['fb_site_name']; ?>" /></td> 
						<td><small>(optional)</small</td>
						</tr>
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[fb_admins]" value="<?php echo $options['fb_admins']; ?>" /></td> 
						<td><small>(optional)</small></td>
						</tr>
						...
						<td width="30px"><input type="text" size="57" name="ographr_options[fb_app_id]" value="<?php echo $options['fb_app_id']; ?>" /></td> 
						<td><small>(optional)</small></td>
						</tr>
