...
if ( is_admin() )
	require_once dirname( __FILE__ ) . '/ographr_admin.php';
...
function ographr_plugin_action_links( $links, $file ) {
	...
	if ( $file == plugin_basename( __FILE__ ) ) {
		$ographr_links = '<a href="'.get_admin_url().'options-general.php?page=meta-ographr/ographr_admin.php">'.__('Settings').'</a>';
